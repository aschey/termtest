...
<p align="center">
  <a href="https://github.com/aschey/termtest/actions?query=workflow%3Aunit-tests"><img alt="GitHub Actions status" src="https://github.com/aschey/termtest/workflows/unit-tests/badge.svg" /></a>
</p>

An automatable terminal session with send/expect controls.

This package leverages the
[go-expect](https://github.com/aschey/termtest/expect) package to test
